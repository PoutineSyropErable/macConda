...
printf "From Francois/Student: It will ask do you want to change your shell .rc files (.zshrc, .bashrc, fish.config) to add conda path and 
...
I have an example of how to manually add it to your rc file on github: conda_activate. I will now run install command\n\n\n"
